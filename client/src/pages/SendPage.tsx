  ...
  return (
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
            ...
            <div>
                ...
                <input value={to} onChange={(e) => {setTo(e.target.value);   if (fieldErrors.to) setFieldErrors((p) => ({ ...p, to: undefined })); }}   className={["mt-1 w-full rounded-md border px-3 py-2 text-sm outline-none",fieldErrors.to ? "border-red-300 focus:border-red-400" : "border-slate-300 focus:border-slate-400",].join(" ")} placeholder='e.g. "+972501234567"' autoComplete="off" />
            ...
            <div>
                ...
                <textarea   value={content}   onChange={(e) => { setContent(e.target.value);  if (fieldErrors.content) setFieldErrors((p) => ({ ...p, content: undefined })); }}  className={["mt-1 w-full rounded-md border px-3 py-2 text-sm outline-none", fieldErrors.content ? "border-red-300 focus:border-red-400" : "border-slate-300 focus:border-slate-400",].join(" ")} rows={5}  placeholder="Write your message..." />
