...
//             <div>
//                 <label className="block text-sm font-medium text-slate-700">To</label>
//                 <input  value={to}   onChange={(e) => setTo(e.target.value)} className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-400" placeholder="e.g. +972501234567" />
//             </div>
//             <div>
//                 <label className="block text-sm font-medium text-slate-700">Content</label>
//             <textarea value={content} onChange={(e) => setContent(e.target.value)} className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-400" rows={4}  placeholder="Write your message..."/>
//             </div>
//             {error && (
...
//                 </div>
//             )}
//             <button disabled={loading} className="rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 disabled:opacity-60">{loading ? "Sending..." : "Send"}</button>
//         </form>
//         </div>
//     );
// }
